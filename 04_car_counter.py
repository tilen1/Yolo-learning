...
def main():
    ...
    # coordinates of the tracking line 
    line_coordinates = [(423, 297), (673, 297)]
    ...
    while True: 
        ...
        for im in result: 
            ...
            for box in boxes: 
                ...
                if class_names[object_id] in ['car', 'truck', 'bus', 'motorbike'] and conf > 0.4:
        ...
        cv2.line(frame, line_coordinates[0], line_coordinates[1], (0, 0, 255), 5)
        ...
        for result in results: 
            ...
            # counting the objects that crossed the line 
            if line_coordinates[0][0]  < cx < line_coordinates[1][0] and line_coordinates[0][1] - 20 < cy < line_coordinates[0][1] + 20 and object_id not in counted_objects:
                object_count += 1
                counted_objects.append(object_id)
                cv2.line(frame, line_coordinates[0], line_coordinates[1], (0, 255, 0), 5)
        ...
        # draw object count 
        cvzone.putTextRect(frame, f'counted vehicles:{str(object_count)}', (100, 100), scale=3, thickness=3, colorR=(0, 255, 0))
